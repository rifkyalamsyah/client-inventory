...
<head>
	...
	<title>Login</title>
	<!-- Custom CSS -->
	<link href="<?= base_url('assets/xtreme_admin_lite/css/style.min.css') ?>" rel="stylesheet"> <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
							...
							<div class="card-body">
								<form class="form-horizontal form-material" id="formLogin">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="email" placeholder="Your Email" class="form-control form-control-line form-user-input" name="email" id="example-email">
										</div>
									</div>
									<div class="form-group">
